...
var fixtures = []fixture{
	...
	fixture{"1.0.0-beta", "1.0.0-versionAlpha.beta"},
	fixture{"1.0.0-versionAlpha.beta", "1.0.0-versionAlpha.1"},
	fixture{"1.0.0-versionAlpha.1", "1.0.0-versionAlpha"},
	fixture{"1.2.3-rc.1-1-1hash", "1.2.3-rc.2"},

	fixture{"v0.0.0", "v0.0.0-foo"},
	fixture{"v0.0.1", "v0.0.0"},
	fixture{"v1.0.0", "v0.9.9"},
	fixture{"v0.10.0", "v0.9.0"},
	fixture{"v0.99.0", "v0.10.0"},
	fixture{"v2.0.0", "v1.2.3"},
	fixture{"v0.0.0", "v0.0.0-foo"},
	fixture{"v0.0.1", "v0.0.0"},
	fixture{"v1.0.0", "v0.9.9"},
	fixture{"v0.10.0", "v0.9.0"},
	...
	fixture{"v0.99.0", "v0.10.0"},
	fixture{"v2.0.0", "v1.2.3"},
	fixture{"v1.2.3", "v1.2.3-asdf"},
	fixture{"v1.2.3", "v1.2.3-4"},
	fixture{"v1.2.3", "v1.2.3-4-foo"},
	fixture{"v1.2.3-5-foo", "v1.2.3-5"},
	fixture{"v1.2.3-5", "v1.2.3-4"},
	fixture{"v1.2.3-5-foo", "v1.2.3-5-Foo"},
	fixture{"v3.0.0", "v2.7.2+asdf"},
	fixture{"v3.0.0+foobar", "v2.7.2"},
	fixture{"v1.2.3-a.10", "v1.2.3-a.5"},
	fixture{"v1.2.3-a.b", "v1.2.3-a.5"},
	fixture{"v1.2.3-a.b", "v1.2.3-a"},
	fixture{"v1.2.3-a.b.c.10.d.5", "v1.2.3-a.b.c.5.d.100"},
	fixture{"v1.0.0", "v1.0.0-rc.1"},
	fixture{"v1.0.0-rc.2", "v1.0.0-rc.1"},
	fixture{"v1.0.0-rc.1", "v1.0.0-beta.11"},
	fixture{"v1.0.0-beta.11", "v1.0.0-beta.2"},
	fixture{"v1.0.0-beta.2", "v1.0.0-beta"},
	fixture{"v1.0.0-beta", "v1.0.0-versionAlpha.beta"},
	fixture{"v1.0.0-versionAlpha.beta", "v1.0.0-versionAlpha.1"},
	fixture{"v1.0.0-versionAlpha.1", "v1.0.0-versionAlpha"},
	fixture{"v1.2.3-rc.1-1-1hash", "v1.2.3-rc.2"},
}
...
func TestBumpMajor(t *testing.T) {
	...
	version, _ = NewVersion("1.0.0+build.1-versionAlpha.1")
	version.BumpMajor()
	if version.PreRelease != "" && version.Metadata != "" {
		t.Fatalf("bumping major on 1.0.0+build.1-versionAlpha.1 resulted in %v", version)
	}
}
